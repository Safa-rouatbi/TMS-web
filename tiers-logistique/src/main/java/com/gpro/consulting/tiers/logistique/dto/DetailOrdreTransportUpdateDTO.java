...
@Data
public class DetailOrdreTransportUpdateDTO {
...
private Long taxeId;
private Double prixTTC; // peut être recalculé côté back mais parfois exposé
...
private Long tourneeId;
    ...
    private List<LigneTransportUpdateDTO> lignesTransport;
    private List<ArticleProduitUpdateDTO> articleProduits;
    private List<ProduitDetailUpdateDTO> produitDetails;
    // private List<AdresseLivraisonUpdateDTO> adresseLivraisonEntities;
}
